...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(551, 458);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        filesavebutton = new QPushButton(centralwidget);
        filesavebutton->setObjectName("filesavebutton");
        filesavebutton->setGeometry(QRect(240, 260, 75, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        statusbar->setToolTip(QCoreApplication::translate("MainWindow", "\346\265\213\350\257\225", nullptr));
